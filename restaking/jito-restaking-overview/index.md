...
![img.png](/shared/images/restaking/ncn.png)
...
- All core activity (computation, validation, data collection, etc.) happens offchain.
...
Participation in Jito (Re)staking is governed by onchain mutual consent:
...
- Accept stake from Vaults and remain compliant to avoid penalties
...
- Participate in voting and contribute to onchain protocol
...
Stakers are users who deposit JitoSOL and other SPL tokens into Vaults to secure NCNs and earn yield. Their capital is the backbone for NCNs because it provides economic security i.e. an economic incentive to follow protocol.
